from sales_Part2 import get_sales_data, calculate_quarter
from file_operations_Part2 import read_sales_data, write_sales_data
...
def main():
    csv_filename = "PythonPAT_CSV_Part2"
    imported_files = set()
    ...
    while True:
        ...
        if choice == 'view':
            ...
            print("\t\t  | TOTAL:   " + str(total) + "\n")
             ...
             amount, year, month, day, region_name = sales_entry
